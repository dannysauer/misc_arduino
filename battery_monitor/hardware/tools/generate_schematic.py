...
inst('C','C3','10u 10V',112,42,'Capacitor_SMD:C_1206_3216Metric','','3.3 V bulk'); wire(112,47,112,52); label('3V3',112,37); label('GND',112,52)
inst('C','C4','100n',120,42,'Capacitor_SMD:C_0805_2012Metric','','3.3 V HF bypass'); wire(120,47,120,52); label('3V3',120,37); label('GND',120,52)
